...
const About = () => {
    ...
    return (
        <div className='my-10 container'>
            <div className='lg:flex lg:flex-row lg:gap-x-5 grid gap-5'>
                <div className='basis-3/5 flex items-center justify-center'>
                    <p className='lg:text-xl text-xl text-center font-semibold'>{about1}</p>
                </div>
                <div className='basis-2/5'>
                    <img className='rounded-2xl lg:rounded-2xl p-5' src={img1} alt="" srcset="" />
                </div>
            </div>

            <div className='lg:flex lg:flex-row flex flex-col-reverse my-10 gap-x-5'>
                <div className='basis-2/5'>
                    <img className='rounded-2xl p-5 lg:rounded-2xl' src={img2} alt="" srcset="" />
                </div>
                <div className='basis-3/5 flex items-center justify-center text-center p-3'>
            ...
            <div className='lg:flex lg:flex-row lg:gap-x-5 grid gap-5'>
                <div className='basis-3/5 flex items-center justify-center'>
                    <p className='g:text-xl text-xl text-center font-semibold'>{about3}</p>
                </div>
                <div className='basis-2/5'>
                    <img className='rounded-2xl p-5 lg:rounded-2xl' src={img3} alt="" srcset="" />
                </div>
            </div>
        </div>
    );
