...
const Testimonial = () => {
  return (
    <div>
      <h2 className="text-2xl leading-6 text-gray-800 text-center px-4 my-10">
        Testimonials
      </h2>
      <h1 className="max-w-2xl mx-auto mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white text-center">
