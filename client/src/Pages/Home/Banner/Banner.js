...
const Banner = () => {
  ...
  return (
            <section class="bg-white dark:bg-gray-900 my-5 banner-height">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Your One Stop Car Service</h1>
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src={hero} className='rounded-2xl' alt="mockup"/>
            </div>
        </div>
    </section>
  );
